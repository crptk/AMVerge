...
pub(super) async fn import_original_cut_into_premiere(
    app: &AppHandle,
...
pub(super) async fn import_into_premiere(
    app: &AppHandle,
    media_paths: &[String],
    abort_requested: &AtomicBool,
) -> Result<String, String> {
...
pub(super) fn build_premiere_ui_import_ps(media_paths: &[String]) -> String {
